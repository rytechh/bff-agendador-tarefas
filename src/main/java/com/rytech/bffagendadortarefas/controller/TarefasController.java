...
public class TarefasController {
    ...
    @ApiResponse(responseCode = "500", description = "Erro de servidor")
    public ResponseEntity<TarefasDTOResponse> atualizaStatusNotificacao(
    ...
    @ApiResponse(responseCode = "500", description = "Erro de servidor")
    public ResponseEntity<TarefasDTOResponse> atualizaTarefa(@RequestBody TarefasDTORequest dto,
                                                             @RequestParam("id") String id,
